    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(urlReferer) && urlReferer.Contains("https://login.partner.microsoftonline.cn"))
                {
                ...
                //从Edoc过来-注销
                _logger.LogInformation($"从Edoc过来-注销： MicrosoftIdentity/Account/SignOut");
        ...
        {
            _logger.LogInformation($"登录： /MicrosoftIdentity/Account/SignIn");
